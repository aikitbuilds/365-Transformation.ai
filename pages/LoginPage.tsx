...
import { BrainCircuitIcon } from '../components/icons/IconComponents';
            ...
            <Card className="w-full max-w-sm">
                ...
                <CardContent>
                    <button
                        ...
                        className="w-full mt-2 px-4 py-2 bg-slate-700 text-white font-semibold rounded-lg hover:bg-slate-600 transition-colors flex items-center justify-center gap-2"
                    >
